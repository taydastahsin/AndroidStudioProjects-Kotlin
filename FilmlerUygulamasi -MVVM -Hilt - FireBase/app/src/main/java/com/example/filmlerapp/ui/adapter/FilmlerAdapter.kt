...
class FilmlerAdapter(var mContext:Context,var filmlerListesi:List<Filmler>)
    ...
    override fun onBindViewHolder(holder: CardTasarimTutucu, position: Int) {
        ...
        val url ="http://kasimadalan.pe.hu/filmler_yeni/resimler/${film.resim}"// Resimleri çektiğimiz veritabanı url si
        Glide.with(mContext).load(url).override(500,750).into(t.imageViewFilm)//İnternetten resimleri çektiğimiz kütüphane kurulumu
