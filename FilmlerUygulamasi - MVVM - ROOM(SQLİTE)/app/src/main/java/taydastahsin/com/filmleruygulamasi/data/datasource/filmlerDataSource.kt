package taydastahsin.com.filmleruygulamasi.data.datasource
...
class filmlerDataSource  {
    ...
    suspend fun dataGet():List<Filmler> = withContext(Dispatchers.IO) {
            val filmlerListesi =
                ArrayList<Filmler>() //Kullancağımız verileri dizi şeklinde tanımladık.
